...
mice_id = ['322MR','327FL','329FRR','331FN']
...
for mouse_id in mice_id:
    ...
    functional_rois_dict_path = f'{base_path}/{mouse_id}/functional_parcellation_rois_dict_NEW_ROI2.h5'
    ...
    file_path = f'{base_path}/{mouse_id}/closest_dict_NEW_ROI2.h5'
