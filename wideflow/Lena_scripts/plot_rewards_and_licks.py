...
[timestamp, cue, metric_result, threshold, serial_readout, trial_number] = extract_from_metadata_file(f'{BASE_PATH}/{date}/'  #added by Claude 20260906
...
fig.savefig(f'{DATA_STAGING_PATH}/exp4_simple_figs/{date}_{mouse_id}_{session_id}')  #added by Claude 20260906
