...
dates_vec = ['20241121',
             '20241126', '20241129', '20241130','20241201']
mice_id = [
    '187FN'
    #'203MN'
    ,'204FR'
...
colors = ['cyan', 'orange', 'purple', 'chartreuse', 'magenta','blue'] #21'cyan',24'blue',31'orange',46'green',54'purple', 63'chartreuse', 64'magenta'
#colors = ['cyan','orange']
mice_and_roi = 'All_mice_uptoNF3'
...
sum = []
for a,b in zip (norm_crossings_allROIs[0], norm_crossings_allROIs[1]):
    sum.append(a+b)

mean_allROIs = [num /len(mice_id) for num in sum]

sum = []
for a,b in zip (norm_crossings[0], norm_crossings[1]):
    sum.append(a+b)
