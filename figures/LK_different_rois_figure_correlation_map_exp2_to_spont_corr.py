...
session_path0 = f'{DATA_STAGING_PATH}/20230604/{mouse_id}/{session_id0}/'  #added by Claude 20260906
# session_path1 = f'/data/Lena/WideFlow_prj/20230604/{mouse_id}/{session_id1}/'
session_path1 = f'{DATA_STAGING_PATH}/20230604/{mouse_id}/{session_id1}/'  #added by Claude 20260906
# session_path2 = f'/data/Lena/WideFlow_prj/20230604/{mouse_id}/{session_id2}/'
session_path2 = f'{DATA_STAGING_PATH}/20230604/{mouse_id}/{session_id2}/'  #added by Claude 20260906
# session_path3 = f'/data/Lena/WideFlow_prj/20230604/{mouse_id}/{session_id3}/'
session_path3 = f'{DATA_STAGING_PATH}/20230604/{mouse_id}/{session_id3}/'  #added by Claude 20260906
...
dataset_path0 = DATA_STAGING_PATH + '/Results/results_exp2.h5'  #added by Claude 20260906
# dataset_path1 = '/data/Lena/WideFlow_prj/Results/results_exp2.h5'
dataset_path1 = DATA_STAGING_PATH + '/Results/results_exp2.h5'  #added by Claude 20260906
# dataset_path2 = '/data/Lena/WideFlow_prj/Results/results_exp2.h5'
dataset_path2 = DATA_STAGING_PATH + '/Results/results_exp2.h5'  #added by Claude 20260906
# dataset_path3 = '/data/Lena/WideFlow_prj/Results/results_exp2.h5'
dataset_path3 = DATA_STAGING_PATH + '/Results/results_exp2.h5'  #added by Claude 20260906
...
for sess_id in sessions_id:
    ...
    for i, (key, val) in enumerate(sessions_meta[sess_id]['rois_proximity'].items()):
        ...
        metric_corr[key] = np.corrcoef(sessions_data[sess_id]['post_session_analysis']['dff_delta5']['zscore'][i],sessions_data[sess_id]['post_session_analysis']['dff_delta5']['zscore'][105])[0,1]
    sessions_data[sess_id]["metric_corr"] = metric_corr
    #sessions_data[sess_id]["dff_corr"] = dff_corr
...
_, _, pmap0 = paint_roi(sessions_meta[sess_id]['rois_dict'],
                      ...
                      sessions_data[sess_id]['metric_corr']) #LK
