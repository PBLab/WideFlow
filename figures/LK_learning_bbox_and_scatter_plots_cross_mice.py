...
for mouse_id in mice_id:
    ...
    cortex_map_path = f'{base_path}/{mouse_id}/20221122_MR_CRC3functional_parcellation_cortex_map.h5'
    rois_dict_path = f'{base_path}/{mouse_id}/20221122_MR_CRC3functional_parcellation_rois_dict.h5'
    ...
    threshold = sessions_data[mouse_id]['20230118_MR_NF18']['post_session_analysis']['analysis_parameters'][
        'fixed_threshold']
    threshold = 2.8
    dff_threshold = 0
    percentile = 95
