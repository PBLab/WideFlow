...
mouse_id = '2604'
session_id0 = '20220210_neurofeedback'
session_id1 = '20220307_neurofeedback'
session_id2 = '20220324_neurofeedback'
session_id3 = '20220320_neurofeedback'
sessions_id = [session_id0, session_id1, session_id2, session_id3]
base_path = '/data/Rotem/WideFlow prj'

session_path0 = f'/data/Rotem/WideFlow prj/{mouse_id}/{session_id0}/'
session_path1 = f'/data/Rotem/WideFlow prj/{mouse_id}/{session_id1}/'
session_path2 = f'/data/Rotem/WideFlow prj/{mouse_id}/{session_id2}/'
session_path3 = f'/data/Rotem/WideFlow prj/{mouse_id}/{session_id3}/'

functional_cortex_map_path = f'{base_path}/{mouse_id}/functional_parcellation_cortex_map.h5'
functional_rois_dict_path = f'{base_path}/{mouse_id}/functional_parcellation_rois_dict_left_hemi.h5'
...
dataset_path0 = '/data/Rotem/WideFlow prj/results/sessions_20220320.h5'
dataset_path1 = '/data/Rotem/WideFlow prj/results/sessions_20220220.h5'
dataset_path2 = '/data/Rotem/WideFlow prj/results/sessions_20220320.h5'
dataset_path3 = '/data/Rotem/WideFlow prj/results/sessions_20220320.h5'
